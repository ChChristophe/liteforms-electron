...
## 17. Post-mortem — vitesse de la voix pilotée par le Mobile (19/09/2026, non validé terrain)
...
* **Reste** : validation terrain (Mobile → appliance : la vitesse choisie s'entend, TTS **et** realtime), puis commit. Audit : `docs/porting/jarvis-openclaw-session-tts-speed-audit.md` (Electron) + `docs/porting/tts-speed-audit.md` (Mobile).
